...
export const translations = {
  en: {
    ...
    privacyPolicyTitle: "Staff Privacy Policy & Terms of Access",
    ...
    introTitle: "CIVENTRAL PORTAL — EMPLOYEE DATA PRIVACY & TERMS OF ACCESS",
  ...
  tl: {
    ...
    // Privacy Policy Modal
    privacyPolicyTitle: "Kebatiran sa Pribado ng Kawani at Patakaran sa Pag-access",
    ...
    introTitle: "CIVENTRAL PORTAL — PRIVACY NG DATOS NG KAWANI AT TERMS NG ACCESS",
